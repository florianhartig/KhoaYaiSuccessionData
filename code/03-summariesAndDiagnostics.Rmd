...
Species counts, listed per Plot

```{r}
speciestable <- with(cleanedData, table(Species, Plot))
addmargins(speciestable)
```

## Per Stage

Species counts, listed per Stage

```{r}
speciestable <- with(cleanedData, table(Species, Stage))
addmargins(speciestable)
```
