...
attach(cleanedData)
stageNames = c("Stand initiation", "Stem exclusion", "Old-growth")
```
...
```{r, fig.height=15, fig.width=15}
  ...
  barplot(density, las = 1, xlab = "Stem number/0.48 ha", space = 1, legend = stageNames , horiz = T, main = "Stem number", args.legend =list(x="topleft"))
