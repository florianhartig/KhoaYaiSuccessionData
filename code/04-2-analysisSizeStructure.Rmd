...
beanplot(predictedTreeHeight ~ Stage , log="", ll = 0.005, add = T, side = "second", names = stageNames) 
...
beanplot(predictedCrownArea ~ Stage , log="", ll = 0.005, add = T, side = "second", names = stageNames) 
