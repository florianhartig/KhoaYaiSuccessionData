...
stagesPerPlot <- as.factor(c("Stand initiation", "Stem exclusion","Stem exclusion", "Old-growth", "Old-growth", "Stem exclusion", "Stand initiation", "Stand initiation"))
...
legend(1,100, legend = unique(stagesPerPlot), col = Gcol, pch = 15)
...
Gcol = c("black", "darkgrey", "lightgrey")
